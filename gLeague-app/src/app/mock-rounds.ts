...
export const ROUNDS: Round[] = [
  ...
  { id: 31, playerid: 3, playername: 'Dave Ma',  dateplayed: new Date("4-30-2018"), courseid: 1, matchhdcp: 26, teeid: 2, nine: 1, score: 38, netscore: 36, putts:18},
  { id: 41, playerid: 3, playername: 'Dave Ma',  dateplayed: new Date("5-06-2018"), courseid: 1, matchhdcp: 26, teeid: 1, nine: 2, score: 39, netscore: 37, putts:18},
